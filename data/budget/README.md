# /data/budget — raw drop zone

Put raw official exports for **budget** here, then convert them into a canonical pack:
...
into `public/data/budget/` and registers it in `public/data/manifest.json`.

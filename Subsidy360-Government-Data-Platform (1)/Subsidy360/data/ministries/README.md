# /data/ministries — raw drop zone

Put raw official exports for **ministries** here, then convert them into a canonical pack:
...
into `public/data/ministries/` and registers it in `public/data/manifest.json`.

# /data/states — raw drop zone

Put raw official exports for **states** here, then convert them into a canonical pack:
...
into `public/data/states/` and registers it in `public/data/manifest.json`.
